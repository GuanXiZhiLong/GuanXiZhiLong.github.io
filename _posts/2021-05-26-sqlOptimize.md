...
title: "SQL语句性能优化策略"
excerpt: "SQL语句性能优化策略"
last_modified_at: 2021-05-26T11:46:06-12:00
header:
tags:
- SQL
toc: true
...
25、查询的关联同写的顺序 ：
```shell 
select a.personMemberID, * from chineseresume a,
personmember b where personMemberID = b.referenceid 
...
29、任何对列的操作都将导致表扫描，它包括数据库函数、计算表达式等等，查询时要尽可能将操作移至等号右边。
